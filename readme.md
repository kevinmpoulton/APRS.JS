...
### Calculate the CRC for the AX25 frame and append it to the frame
...
### Add the necessary FX25 Forward Error Correction
...
### Encode the final frame in audio
